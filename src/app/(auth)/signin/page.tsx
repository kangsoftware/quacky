        ...
        <div className="min-h-screen w-full flex items-center justify-center bg-background relative">
            <div className="w-full max-w-sm space-y-8">
                ...
                <div className="text-center">
                    <img src="/assets/quackythebird/sleeping.png" alt="Quacky" className="w-40 h-40 object-contain mx-auto mb-0" />
                    <h1 className="text-3xl font-extrabold tracking-tight text-primary dark:text-primary-dark">Sign in to Quacky</h1>
